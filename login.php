...
<body style="background-color: 43C0E8;">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="process_login.php">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-user btn-block" name="submit" style = "background-color : #43C0E8;">
                                           <i class="fa fa-spinner" ></i>Login
                                        </button>
                                        <hr>
                                    </form>
                                    <div class="text-center">
                                        <a class="normal" href="register.php">Belum punya akun?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
